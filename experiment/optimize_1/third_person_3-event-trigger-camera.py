...
def mark_task_finished(food_id: Union[int, str], task_list_path="experiment/optimize_1/task_list.json"):
...
def senario():
   ...
   and prev_action[0] == "pick_up" and transported == False:
    ...
    # 記錄 total frames
    with open("experiment/optimize_1/frame_log-event-trigger.txt", "a") as log:
