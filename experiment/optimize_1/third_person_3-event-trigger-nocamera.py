...
def mark_task_finished(food_id: int, task_list_path="experiment/optimize_1/task_list.json"):
...
def issue_action(replicant, action_name, index, target=None):
    ...
    if is_robot:
        agent_name = "🤖 Robot1"
        task_path = "experiment/optimize_1/task_list.json"
    elif is_robot2:
        agent_name = "🦾 Robot2"
        task_path = "experiment/optimize_1/task_list.json"
    else:
...
def print_finished_foods(task_list_path="experiment/optimize_1/task_list.json"):
    with open(task_list_path, "r") as f:
        task_list = json.load(f)
...
def senario():
    c = TransportChallenge(port=8888, screen_width=1280, screen_height=720)
        ...
        for i in [0, 1, 2]:
            ...
            if human_interference:
                ...
                replicant_position, replicant2_position = transform_to_dict(replicant_position, 
                                                                            replicant2_position)
                new_robot_tasks, new_robot2_tasks = get_human_finished_tasks(replicant_position, replicant2_position, 
            ...
            if rep.action is None or rep.action.status != ActionStatus.ongoing:
                ...
                while indices[i] < len(task_list):
                    ...
                    #         print(f"❗ The food with ID {food_id} has already been completed by another 🤖 Robot during navigate_to.")
   ...
   and prev_action[0] == "pick_up" and transported == False:
                        if i in [0, 2]:  # robot1 or robot2
                            ...
                            mark_task_finished(prev_action[1])
    ...
    print("======================================================================")
    reset_robot_task_list("experiment/optimize_1/task_list.json")
    ...
    # 記錄 total frames
    # with open("experiment/optimize_1/frame_log-2.txt", "a") as log:
...
if __name__ == "__main__":
    ...
    shutil.copyfile('experiment/optimize_1/task_list_all.json', 'experiment/optimize_1/task_list.json')
    shutil.copyfile('experiment/optimize_1/task_list_all.json', 'experiment/optimize_1/robot_task_list.json')
    shutil.copyfile('experiment/optimize_1/task_list_all.json', 'experiment/optimize_1/robot2_task_list.json')
    senario()
