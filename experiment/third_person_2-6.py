...
from experiment.robot_camera import process_latest_image
import json
import numpy as np
import random
import os, glob
...
def senario():
    ...
    while any(active):
        ...
        process_latest_image("experiment/robot_first_person/human_robot_2/a")
   ...
   and prev_action[0] == "pick_up" and transported == False:
    ...
    # 記錄 total frames
    with open("experiment/totalframes_5_2-6/frame_log.txt", "a") as log:
