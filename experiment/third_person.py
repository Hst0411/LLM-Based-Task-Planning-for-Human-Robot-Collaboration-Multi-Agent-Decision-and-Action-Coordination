...
def senario():
    ...
    image_folder = "experiment/robot_first_person/human_third_person/a"
    # 找出資料夾內所有 .jpg 檔案
    ...
    cam = ThirdPersonCamera(avatar_id="a",
                        ...
                        look_at=c.replicants[1].replicant_id)
    
    c.add_ons.append(cam)
    
    # 加入 image capture 模組，並設定 camera 為 avatar "a"
    capture = ImageCapture(path="experiment/robot_first_person/human_third_person", avatar_ids=["a"])
